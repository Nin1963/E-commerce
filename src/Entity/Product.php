...
class Product
{
     ...
     * @Assert\Length(min=20, minMessage="La description courte doit contenir au moins 20 caractères")
     */
    private $shortDescription;

    // public static function loadValidatorMetData(ClassMetadata $metadata) {
